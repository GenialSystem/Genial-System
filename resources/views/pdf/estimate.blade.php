...
<body class="font-tome antialiased bg-[#F5F5F5] p-4">
    ...
    <div class="2xl:flex 2xl:space-x-4 mt-4">
        ...
        <div class="2xl:w-2/3 mt-4 2xl:mt-0 bg-white p-4 mb-12 2xl:mb-0">
            <div class="p-1 bg-[#F2F1FB] mb-4">
                <span class="text-[15px] text-[#222222] flex"> <img class="px-2"
                        src="{{ asset('images/preventivi icona.svg') }}" alt="general data icon"> Dati
                    preventivo</span>
            </div>
            <div class="mb-4">
            ...
            <span
                class="bg-[#66C0DB] px-4 py-0.5 rounded-2xl text-white text-[15px] font-semibold">{{ $estimate->price }}
                €</span>
        </div>
