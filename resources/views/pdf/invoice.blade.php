                ...
                <div class="px-2 space-y-4">
                    ...
                    @if ($invoice->user->hasRole('customer'))
                        <div>
                            ...
                            <span
                                class="text-[#222222] text-[15px]">{{ $invoice->user->customerInfo->admin_name }}</span>
                        </div>
                    @endif
                    <div>
                    ...
                    <div>
                        ...
                        <span
                            class="text-[#222222] text-[15px]">{{ $invoice->user->created_at->format('d/m/Y') }}</span>
                    </div>
                </div>
            </div>
                ...
                <div class="px-2 space-y-4">
                    @if ($invoice->user->hasRole('customer'))
                        ...
                        <div>
                            ...
                            <span
                                class="text-[#222222] text-[15px]">{{ $invoice->user->customerInfo->rag_sociale }}</span>
                        </div>
                        <div>
